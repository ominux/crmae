...
to the DRAM-style refresh. For the same reason, our scheme results in less than 90\% of performance penalty taking into our observation that about 10\% of the total diminishing blocks need to written back to the main memory. Although our scheme has 4\% more area overhead, the large refreshing benefits obtained justifies our design. Moreover, refreshing benefits will diminish radically if it is done at {\it $\mu$s} level, and hence our $ms$ proposal help in sustaining the energy benefits.
