...
\centering
 ...
 \hrule
 \caption{\label{fig:mram_cell} \scriptsize \bf Demonstration of three switching phases: thermal activation, dynamic reversal and precessional switching.}
%\end{figure*}
\end{wrapfigure}
...
\begin{table*}[t]
 \scriptsize
  ...
  & & & ($mm^2$) & ($ns$) & ($ns$) & ($nJ$) & ($nJ$) & ($mW$) \\
  	...
  	\cline{2-3}\cline{4-9}
    & \multirow{2}{*}{$t=100ms$} & Leakage Opt. & $2.181$ & $1.994$ & $3.432$ & $0.575$ & $0.608$ & $1250$ \\
  	\cline{3-3}\cline{4-9}
