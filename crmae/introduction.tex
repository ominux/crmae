...
Designing an efficient memory hierarchy for multi-core architectures is a critical and a challenging
...
\noindent
\textbf{Detailed characterization of STT-RAM volatile property:} We present a detailed
