...
The first effort to vary the retention time of STT-RAM cells for facilitating designing STT-RAM-based
...
Also, such a design
makes the LLC design homogenous (all same type of STT-RAM cells) leading to lower die cost and ease in fabrication.
